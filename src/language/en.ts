const en = {
  ...
  about: "About",
  search: "Search",
  heroTitle: "Lead the Personal Care Revolution with àmàri.",
  ...
  metaDescription:
    "Àmàri is shaping the future of personal care in Africa. We are bold, inclusive and innovative. We are building not just a brand but an entire ecosystem,  one that delivers results, opens opportunities, and redefines what beauty can mean for a new generation.",
  ...
  popularProducts: "Some Of Our Formulations...",
  popularProductsDescription:
    "Our hair and scalp care formulas meet the highest standards, ensuring that your customers can achieve and maintain healthy, beautiful hair.",
  promoTitle:
    "Now Available For Retail: Caffeine Scalp Serum + pH Balancing Scalp Cleanser",
  promoDescription:
    "Welcome to the heart of Amari, Our community, a vibrant, purpose-driven network of people who care deeply about what goes on and into their bodies from scalp to toe, we are building a movement around clean beauty, holistic wellness, and empowered living.",
  days: "Days",
  hours: "Hours",
  minutes: "Minutes",
  seconds: "Seconds",
  ...
  newsletterDescription:
    "Stay in the loop with the latest updates, exclusive offers, and expert tips from Amari that our monthly newsletter brings you.",
  email: "Email",
  send: "Send",
  effectivenessFaq: "The effectiveness of amari products",
  effectivenessFaqDescription:
    "Our products are designed to provide long-term benefits for the hair, not just short-term solutions. We use only the highest quality bio-active ingredients, to create products that are safe and effective.",
  questionOne: "What makes Amari Hair Care products unique?",
  answerOne:
    "Our products are crafted with 100% plant-based, oil-free formulas and clinically proven active ingredients. Our commitment to natural ingredients ensures that our products are gentle yet effective",
  ...
  answerFour:
    'We only retail our scalp care products. You can place an order by clicking "Shop Now" on the menu. As a stockist, click "Catalogue" and fill out the order form under the "Place an Order" section. If you are a new stockist, select the "New Stockist" tab, and if you are a returning stockist, select the "Returning Stockist" tab.',
  ...
  answerSix:
    "Delivery times may vary depending on your location and quantity. Typically, orders are delivered within 1-3 business days. For international orders, delivery may take longer.",
  ...
  answerTen:
    "For kids, it's best to use child-specific hair care products from around 6 months of age. For infants younger than 6 months, stick to products designed for babies. Consult with a pediatrician if you have any concerns about specific products or ingredients.",
  ...
  emailAddress: "support@amarihaircare.com",
  aboutUs: "About Us",
  whoWeAre: "Who We Are",
  ...
  productMetaDescription:
    "Our products, are designed to meet the highest standards of quality and effectiveness, offers unparalleled benefits for your needs.",
  productMetaTitle: "Product | Our hair product page",
  catalogueMetaTitle: "Catalogue | Amari Hair Care (Shop)",
  catalogueMetaDescription:
    "Explore our top hair and scalp care products. These are premium, plant-based solutions made with African-sourced botanicals and backed by innovation to meet your hair’s unique needs.",
  errorPage: "Error Page",
  productPageDescription:
    '<p style="text-align:center">Our products, are designed to meet the highest standards of quality and effectiveness, offers unparalleled benefits for your needs.</p>',
  ...
  cataloguePageDescription:
    `<p style="text-align:center">Explore our top hair and scalp care products. These are premium, plant-based solutions made with African-sourced botanicals and backed by innovation to meet your hair’s unique needs.
</p>`,
  ...
  cataloguePageMoreInfoDescription:
    "Discover a world of luxurious hair care products at Amari Hair Care, where innovation meets nature. Amari uses bio-active ingredients (including those derived from Africa’s rich botanical heritage) to make safe and effective personal care products. We have a dedicated section for all your hair care needs, featuring a wide range of products from shampoos and conditioners to hair treatments and styling products.",
  amariDifferenceTitle: "THE AMARI DIFFERENCE",
  amariDifferenceLineOne:
    "Add Amari to your routine without changing everything you already use. Our products are designed to complement existing haircare systems while addressing what most routines overlook, the scalp.",
  amariDifferenceLineTwo:
    "<b>Add Amari to Your Routine. Start at the Scalp. Change Your Hair.</b>",
  whyChooseAmariHairCare: "Why Choose Amari Hair Care?",
  whyChooseAmariHairCareDescription:
    "In today’s fast-paced world, you deserve care that actually works. At Amari, we understand that healthy hair starts with a healthy scalp. Our mission is to empower confidence and self-expression through thoughtfully formulated products that address real hair and scalp needs.",
  topCategories: "Top Categories",
  topCategoryScalpCare:
    "<b>Scalp Care:</b> Promote optimal scalp health with targeted treatments designed to soothe irritation, reduce buildup, and create the right environment for healthy hair growth. <br> <br> Amari scalp treatments are designed to work with any haircare range, targeting scalp health to improve overall hair results",
  topCategoryHairCare:
    "<b>Hair Care/Length Retention Products:</b> Strengthen, repair, and maintain your hair with products formulated to support growth, resilience, and length retention.",
  ...
  premiumIngredients:
    "<b>Premium Ingredients</b>: Our products are enriched with carefully selected, high-quality ingredients chosen for their proven benefits. Each formulation is designed to support scalp balance, strengthen hair, and deliver visible results.",
  streamlinedOrderingProcess:
    "<b>Streamlined Ordering Process</b>: Our platform is simple and intuitive, allowing you to easily find and order the products you need, whether you are shopping now or planning ahead..",
  competitivePricingAndExclusiveOffers:
    "<b>Competitive Pricing and Exclusive Offers</b>: Enjoy premium products at accessible prices. Benefit from fast delivery, flexible returns, and value-driven offers designed to make quality hair and scalp care easy to maintain.",
  exploreDescription:
    "Explore our extensive collection of hair care products and elevate your product range with Amari Hair Care. Continue browsing our website to discover premium products that will help you offer your customers healthy, beautiful hair solutions.",

  filter: "Filter",
  noResults:
    "No Results found with the search term. Check out our other hair products",
  stockistPageDescription:
    '<p style="text-align:center">Join our network of trusted partners by becoming an authorized stockist of Amari Hair Care products. Our stockist program offers exclusive access to our premium, plant-based hair and scalp care products. </p>',
  ...
  stockistMetaDescription:
    "Do you want to be a distributor? Join the Amari Hair Care family and get the best in hair care. Fill out the form below to place an order and we will get back to you. Not a Distributor? Click Shop to Shop Now or View Stockists",
  ...
  aboutPageDescription: `<p style="text-align:center">
  
  Learn more about Amari Hair Care, our mission, and our commitment to providing premium, plant-based hair care products that promote healthy, beautiful hair with Rooted in Nature. Backed by Science. Created for You.
</p>`,
  faqPageDescription:
    '<p style="text-align:center">Find answers to frequently asked questions about Amari Hair Care products, stockist program, and more. If you have any other questions, feel free to contact us.</p>',
  ...
  aboutPageMetaDescription:
    "Learn more about Amari, our mission, and our commitment to providing premium, plant-based hair care products that promote healthy, beautiful hair.",
  aboutUsPageHeading:
    "We Are Building Africa’s L’Oréal",
  aboutUsPageDescription:
    `An ecosystem, not just a product line.
Àmàri is more than a premium hair and scalp care brand. We are pioneering a holistic beauty model designed for the future of personal care.
From high-performance products to professional services, education, and community, we are laying the foundation for a new kind of beauty giant rooted locally and scaled globally.`,
  ...
  cartPageDescription: '<p style="text-align:center">Review the items in your cart and proceed to checkout to complete your purchase.</p>',
  checkoutPageDescription: '<p style="text-align:center">Complete your purchase by providing your shipping and payment information.</p>',
  orderSuccessPageDescription:
    '<p style="text-align:center">Your order has been received and is currently awaiting confirmation. Please check your email for your order details.</p>',
};
