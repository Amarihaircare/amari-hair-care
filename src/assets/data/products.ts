...
export const products = [
  {
    ...
    shortDescription:
      `A targeted scalp treatment that stimulates hair growth and deeply moisturizes dry, flaky scalp.
This plant-based serum is powered by caffeine, a proven ingredient that helps activate hair follicles, improve scalp circulation, and block DHT, a key contributor to hair thinning. Enriched with nourishing botanicals, it supports longer hair growth cycles and helps boost volume by up to 33%.
Lightweight and non-greasy, the formula absorbs quickly and is suitable for daily use on all hair types, including natural, relaxed, and chemically treated hair.
Key Benefits
Promotes fuller, thicker hair


Hydrates and soothes dry scalp


Safe for all hair textures


100 percent plant-based and non-irritating.`,
    prices: [
      {
        amount: 10000,
        currency: "NGN",
    ...
    description:
      `<b>WHY PEOPLE PREFER CAFFEINE</b><br/><br/>
      Caffeine is becoming a popular choice for people looking to grow thicker, healthier hair without the risk of harsh side effects. 
      Here’s why caffeine-based scalp products are gaining attention as a safe and effective solution:`,
    ingredients:
      "Aqua, Aloe Vera, Peppermint, Rice Extract, Caffeine, Lavender, Clove, Vegetable Glycerin",
    howToUse:
      `Apply a few drops directly to the scalp, focusing on problem areas.
 Massage gently to support absorption and circulation.
...
export const promo = {
  title: "Join the Amari Community Where Clean Beauty Meets Conscious Living",
  price: 29000,
