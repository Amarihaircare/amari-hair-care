...
export default function Footer() {
  return (
    <footer className="footer py-20 lg:py-40 w-full flex justify-center bg-primary transition-all duration-300">
      <div className="flex flex-col lg:flex-row flex-wrap lg:gap-y-20 items-center lg:items-start justify-between md:max-w-screen-sm xl:max-w-screen-lg 2xl:max-w-screen-xl w-full gap-10 lg:gap-0 px-4">
