...
export default function NewsletterSection() {
  return (
    <section className="newsletter_section pb-20 lg:pb-40 w-full flex-col flex items-center justify-center bg-white">
      <div className="newsletter_container flex rounded bg-primary flex-col items-center justify-center w-full overflow-hidden px-4 lg:px-0 md:max-w-[95%] 2xl:max-w-screen-xl relative py-20 text-white bg-no-repeat">
