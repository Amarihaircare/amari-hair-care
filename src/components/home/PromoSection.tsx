...
export default function PromoSection() {
  ...
  return (
    <section className="promo_section py-20 lg:py-40 w-full flex-col flex items-center justify-center bg-background">
      <div className="promo_container flex flex-col lg:flex-row justify-between items-center w-full overflow-hidden px-4 md:max-w-[95%] 2xl:max-w-screen-xl gap-10">
