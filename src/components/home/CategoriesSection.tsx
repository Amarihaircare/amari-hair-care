...
export default function CategoriesSection() {
  return (
    <div className="categories bg-white w-full py-40 flex items-center justify-center">
      <ul className="categories_list grid grid-cols-6 gap-8 md:max-w-screen-sm w-full px-4 xl:max-w-screen-lg 2xl:max-w-screen-xl">
        {categories.map((category, index) => (
          <li key={index} className="flex flex-col items-center" data-order="1">
            <Image
              src={category.image}
              alt="media"
              width={200}
